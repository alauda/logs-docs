...
| 4 | Global and workload clusters | Run the controlled uninstall of the legacy plugin | Those three objects stay absent for 60 seconds and new log queries still pass |
