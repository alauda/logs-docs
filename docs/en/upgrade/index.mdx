...
type: Opaque
stringData:
  endpoints: "https://<opensearch-lb>:9200"       # Comma-separated HTTP(S) URLs; put the highly available coordinator or load balancer first
