...
- If you need to integrate object storage or use S3-based cold and hot separation for ClickHouse log data, it is recommended that you evaluate the ACP Log Storage with Clickhouse plugin first.
