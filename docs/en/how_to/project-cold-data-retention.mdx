...
This guide explains how to configure a project-level cold data retention policy when ClickHouse cold and hot separation is enabled.

## Before You Begin

Make sure the following conditions are met:

1. The cluster uses **Alauda Container Platform Log Storage with Clickhouse**.
2. **Cold and Hot Separation** is enabled for the ClickHouse storage plugin.
3. A cold data S3 Secret has already been configured for the ClickHouse storage plugin.
4. Project-level log policy is enabled for the target project.
