...
- For **Alauda Container Platform Log Storage for ClickHouse** or **for OpenSearch**, use the **Advanced Configuration** section of the plugin install form to set the node selector and tolerations. See [Installation](../install/index.mdx).
